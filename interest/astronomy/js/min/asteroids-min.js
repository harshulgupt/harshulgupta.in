...
third=height*4;fourth=height*6;fifth=height*8;base=parseInt($('.rocket').css('margin-top'));spaceStart=$("#rocket-screen").offset().top-height/4;spaceEnd=spaceStart+height/4;}
